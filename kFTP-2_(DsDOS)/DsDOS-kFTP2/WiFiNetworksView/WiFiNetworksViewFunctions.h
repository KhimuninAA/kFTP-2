...
void WiFiNetworksViewShow() {
    ...
    push_pop(bc, hl, de) {
        ...
        c = (a = WiFiNetworksViewColor);
        l = (a = WiFiNetworksViewX);
        h = (a = WiFiNetworksViewY);
        e = (a = WiFiNetworksViewDX);
        d = (a = WiFiNetworksViewDY);
...
void WiFiNetworksViewShowTitle() {
    push_pop(hl, bc, de) {
        ...
        bios(a = biosPrintMessageHL, hl = WiFiNetworksViewTitle);
        // LINE!!!
        a = WiFiNetworksViewX;
        a += 1;
        l = a;
